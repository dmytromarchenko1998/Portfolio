  ...
  <section id="about">
    <div className="about-container">
      ...
      <div className="about-body">
        ...
        <p>For the Back End, I have most commonly used Express with the REST API, but I have also have used Prisma and GraphQL for making API calls. And for databases, I have a strong understanding of MongoDB and PostgreSQL but have also used MySQL. I have experience with working with Geo-Queries and am comfortable with a lot of Google's API's such Maps and Places.</p>
        <p>I also have experience with deployment of applications. I'm very familiar with deployment directly on AWS using services such as EC2 and RDS and a Load Balancer. I also have experience with using Docker for deployment. For testing, I use a combination of Jest, Enzyme, and Mocha.</p>
        <p>My passion lies in creating and building new applications from the ground up. Please feel free to contact me at 925-457-1925. I love meeting new people and I can't wait to start coding!</p>
      </div>
